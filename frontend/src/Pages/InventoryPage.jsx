                ...
                <table className="w-full text-left border-collapse table-fixed">
                    <thead className="bg-gray-100 border-b border-gray-200">
                        <tr className="divide-x divide-gray-200">
                            <th className="w-[8%] px-2 py-2 text-[10px] font-bold uppercase text-gray-600 text-center">Code</th>
                            <th className="w-[8%] px-2 py-2 text-[10px] font-bold uppercase text-gray-600 text-center">ID</th>
                            <th className="w-[18%] px-2 py-2 text-[10px] font-bold uppercase text-gray-600 text-center">Product Name</th>
                            <th className="w-[10%] px-2 py-2 text-[10px] font-bold uppercase text-gray-600 text-center">Category</th>
                            <th className="w-[5%] px-2 py-2 text-[10px] font-bold uppercase text-gray-600 text-center">Unit</th>
                            <th className="w-[6%] px-2 py-2 text-[10px] font-bold uppercase text-gray-600 text-center">Pcs/Pkt</th>
                            <th className="w-[6%] px-2 py-2 text-[10px] font-bold uppercase text-gray-600 text-center">Pcs/Ctn</th>
                            <th className="w-[9%] px-2 py-2 text-[10px] font-bold uppercase text-gray-600 text-center">Purchase (৳)</th>
                            <th className="w-[8%] px-2 py-2 text-[10px] font-bold uppercase text-gray-600 text-center">Com. Comm.</th>
                            <th className="w-[6%] px-2 py-2 text-[10px] font-bold uppercase text-gray-600 text-center">Com. Disc.</th>
                            <th className="w-[8%] px-2 py-2 text-[10px] font-bold uppercase text-gray-600 text-center">Stock</th>
                            <th className="w-[8%] px-2 py-2 text-[10px] font-bold uppercase text-gray-600 text-center pr-4">Actions</th>
                        </tr>
                    </thead>
