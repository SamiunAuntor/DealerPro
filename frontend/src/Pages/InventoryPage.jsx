    ...
    return (
        <div className="flex flex-col h-full w-full bg-white px-2 py-2">
            ...
            <div className="flex items-center justify-between mb-2 px-1">
                <h1 className="text-lg font-bold text-gray-800 tracking-tight">Product Inventory</h1>
                ...
                <div className="flex items-center gap-2">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="pl-8 pr-3 py-1.5 bg-gray-50 border border-gray-200 rounded text-xs w-60 focus:outline-none focus:border-blue-500"
                        />
                    </div>
                    <button
                        onClick={() => setIsModalOpen(true)}
                        className="bg-slate-800 hover:bg-slate-900 text-white px-3 py-1.5 rounded text-xs font-bold transition-all flex items-center gap-2"
                    >
            ...
            {/* Grid-Style Table with Gray Borders */}
            <div className="flex-1 overflow-hidden border border-gray-200 rounded">
                <table className="w-full text-left border-collapse table-fixed">
                    <thead className="bg-gray-100 border-b border-gray-200">
                        <tr className="divide-x divide-gray-200">
                            <th className="w-[8%] px-2 py-2 text-[10px] font-bold uppercase text-gray-600">Code</th>
                            <th className="w-[8%] px-2 py-2 text-[10px] font-bold uppercase text-gray-600">ID</th>
                            <th className="w-[18%] px-2 py-2 text-[10px] font-bold uppercase text-gray-600">Product Name</th>
                            <th className="w-[10%] px-2 py-2 text-[10px] font-bold uppercase text-gray-600">Category</th>
                            <th className="w-[5%] px-2 py-2 text-[10px] font-bold uppercase text-gray-600 text-center">Unit</th>
                            <th className="w-[6%] px-2 py-2 text-[10px] font-bold uppercase text-gray-600 text-center">Pkt/Pcs</th>
                            <th className="w-[6%] px-2 py-2 text-[10px] font-bold uppercase text-gray-600 text-center">Ctn/Pcs</th>
                            <th className="w-[9%] px-2 py-2 text-[10px] font-bold uppercase text-gray-600">Purchase (৳)</th>
                            <th className="w-[8%] px-2 py-2 text-[10px] font-bold uppercase text-gray-600 text-center">Comm.</th>
                            <th className="w-[6%] px-2 py-2 text-[10px] font-bold uppercase text-gray-600 text-center">Disc.</th>
                            <th className="w-[8%] px-2 py-2 text-[10px] font-bold uppercase text-gray-600 text-center">Stock</th>
                            <th className="w-[8%] px-2 py-2 text-[10px] font-bold uppercase text-gray-600 text-right pr-4">Actions</th>
                        </tr>
                    </thead>
                    <tbody className="divide-y divide-gray-200">
                        {staticProducts.map((p) => (
                            <tr key={p._id} className="hover:bg-gray-100 divide-x divide-gray-200 transition-colors">
                                <td className="px-2 py-1.5 text-xs font-medium text-gray-700">{p.code}</td>
                                <td className="px-2 py-1.5 text-[10px] text-gray-500">{p.product_id}</td>
                                <td className="px-2 py-1.5 text-xs font-semibold text-gray-800 truncate">{p.name}</td>
                                <td className="px-2 py-1.5 text-[10px] uppercase font-bold text-gray-400">{p.category}</td>
                                ...
                                <td className="px-2 py-1.5 text-xs font-bold text-blue-700 bg-blue-50/20">৳{p.purchase_price}</td>
